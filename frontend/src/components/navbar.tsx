      ...
      <div className="max-w-7xl mx-auto h-20 px-4 sm:px-6 flex items-center justify-between">
        ...
        >
          <img
            src="/Logo.png"
            alt="JobSphere"
            className="w-9 h-9 sm:w-10 sm:h-10 rounded-full object-cover ring-1 ring-[#E4E2DC] transition-transform duration-300 group-hover:scale-105 group-hover:rotate-6"
          />

          <div className="leading-tight">
            <h1 className="font-display font-semibold text-lg sm:text-xl tracking-tight">
        ...
        <div className="hidden lg:flex items-center gap-1">
          ...
          <Link to="/rooms" className={navItemClass("/rooms")}>
            <Users size={16} />
            Rooms
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="hidden lg:block">
            {user ? (
                  ...
                  {userMenuOpen && (
                    ...
                    >
                      ...
                      <Link to="/saved-jobs" onClick={closeUserMenu} className={userLinkClass("/saved-jobs")}>
                        <Bookmark size={16} className="text-[#12151C]/35" />
                        Saved Jobs
                      </Link>
              ...
              <div className="flex items-center gap-2">
                <Link
                  to="/login"
                  className="px-4 py-2.5 rounded-xl text-sm font-semibold text-[#12151C]/70 hover:bg-[#F6F5F2] transition-colors"
                >
                  Log in
                </Link>
                <Link
                  to="/register"
                  className="px-4 py-2.5 rounded-xl bg-[#12151C] text-white text-sm font-semibold hover:bg-[#2F5D50] transition-colors duration-200"
                >
                  Sign up
                </Link>
              </div>
          ...
          <button
            ...
            className="lg:hidden flex items-center justify-center w-10 h-10 rounded-xl bg-[#EAF1EE] text-[#2F5D50] hover:bg-[#D3E3DC] transition-colors flex-shrink-0"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden absolute top-full left-0 right-0 bg-white border-b border-[#E4E2DC] shadow-[0_12px_32px_-8px_rgba(18,21,28,0.15)] z-40 overflow-hidden"
          >
